...
class Game:
    ...
    def introduction(self): #displays rules and asks the user if they want to play single player or multiplayer. void
        ...
        while player_1_input_valid is False:
            ...
            if(player_1_input == '1'):
                self.player_2_name = input("What is the 2nd player's name?\n")
                self.player_2 = Human()
    ...
    def compare_gestures(self):
        ...
        if (self.player_1.chosen_gesture == 'Rock' and self.player_2.chosen_gesture == 'Scissors'):               #Rock curshes scissors
            ...
            print(f'Rock crushes scissors! {self.player_2_name} wins!\n')
            ...
            print(f'Rock crushes Lizard! {self.player_2_name} wins!\n')
            self.player_2.wins += 1  
            ...
            print(f'Scissors cuts paper! {self.player_2_name} wins!\n')
            self.player_2.wins += 1
            ...
            print(f'Scissors crushes Lizard! {self.player_2_name} wins!\n')
            self.player_2.wins += 1
            ...
            print(f'Paper suffocates Rock! {self.player_2_name} wins!\n')
            self.player_2.wins += 1
            ...
            print(f'Paper overwhelms Spock! {self.player_2_name} wins!\n')
            self.player_2.wins += 1
            ...
            print(f'Lizard licks paper into a drooly mess! {self.player_2_name} wins!\n')
            self.player_2.wins += 1
            ...
            print(f'Spock dismantles scissors! {self.player_2_name} wins!\n')
            self.player_2.wins += 1
            ...
            print(f'Spock phasers Rock into dust! {self.player_2_name} wins!\n')
            self.player_2.wins += 1
    ...
    def display_winner(self): #once two wins are achieved by either player, this is displayed. void, funtion complete.
        ...
        if (self.player_1.wins == 2):
            ...
            print(f"{self.player_2_name} has won the game!\n")
        elif (self.ai.wins == 2):
